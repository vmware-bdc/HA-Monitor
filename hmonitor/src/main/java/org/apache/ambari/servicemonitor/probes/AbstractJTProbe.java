...
public abstract class AbstractJTProbe extends Probe {
  protected String host;
  protected int port;
  protected URI jturi;

  public AbstractJTProbe(
    String name,
    Configuration conf) throws IOException {
    super(name, conf);
    DFSUtils.makeDfsCallsNonBlocking(conf);
    String jtpath = MonitorUtils.extractJobTrackerParameter(conf);
    jturi = MonitorUtils.getJTURI(jtpath);
    host = jturi.getHost();
    port = jturi.getPort();
  }
